# Contributing to Antigravity Chat Organizer

Thank you for your interest in contributing to Antigravity Chat Organizer! We welcome contributions of all kinds, whether you are fixing a bug, improving documentation, or proposing new features.
...
1. **Fork the repository** and clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/antigravity-chat-organizer.git
...
Antigravity Chat Organizer requires **Node.js 20+ LTS** and npm.
